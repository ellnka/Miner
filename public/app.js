	...
	var Game = function () {
	  ...
	  _createClass(Game, [{
	    ...
	    value: function _isCellVisited(r, c) {
	      var cell = this._gameFieldElem.querySelector("#id" + r + "-" + c + "");
	    ...
	    key: '_isCellMarkedAsBomb',
	    value: function _isCellMarkedAsBomb(r, c) {
	      var cell = this._gameFieldElem.querySelector("#id" + r + "-" + c + "");
	    ...
	    value: function _openAllCells() {
	      for (var i = 0; i < this._width; i++) {
	        for (var j = 0; j < this._height; j++) {
	          var cell = this._gameFieldElem.querySelector("#id" + i + "-" + j + "");
	    ...
	    key: '_updateScoreElem',
	    value: function _updateScoreElem() {
	    ...
	    key: '_openSettingsDialog',
	    value: function _openSettingsDialog() {
	      this._settingsDialog.style.display = "block";
	    }
	  }, {
	    key: '_closeSettingsDialog',
	    value: function _closeSettingsDialog() {
	    ...
	    value: function _startNewGame() {
	      var height = this._settingsDialog.querySelector(".miner-row-count").lastChild.value;
	      var width = this._settingsDialog.querySelector(".miner-column-count").lastChild.value;
	      var bombCounter = this._settingsDialog.querySelector(".miner-bomb-count").lastChild.value;
	      ...
	      if (!this._isCellVisited(row, column) || this._isCellMarkedAsBomb(row, column)) {
	        ...
	        if (this.openedBombCount == this._bombCount) {
	          ...
	          for (var i = 0; i < this._mines.length; i++) {
	            var _cell = this._gameFieldElem.querySelector("#id" + this._mines[i][0] + "-" + this._mines[i][1] + "");
	    ...
	    key: 'settingsOnClick',
	    value: function settingsOnClick(e) {
	      var elem = e.target;
